...
<body>
    ...
    <div class="container m-5">
        ...
        <div class="list-group mt-3">
            <a href="<?php echo e(url('/bootstrap-clone')); ?>" class="list-group-item list-group-item-action bg-light">
            ...
            <div class="list-group mt-2">
                <a href="#" class="list-group-item list-group-item-action bg-light" style="color: red">
...
<?php /**PATH C:\xampp\htdocs\modul_11\resources\views/routing.blade.php ENDPATH**/ ?>